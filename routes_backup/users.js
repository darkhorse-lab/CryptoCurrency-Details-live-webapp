...
router.get('/checkingHighchart',function(req, res){
  // To check .. getting historical price of cryptocurriences
  cc.priceHistorical('BTC', ['USD', 'EUR'], new Date('2017-01-01', '2017-01-02'))
  .then(prices => {
    console.log(prices)
...
router.get('/chartshow/:name', function(req, res){
  ...
  res.render('chartPage', {json_obj: JSON.stringify(obj)});
